            ...
            try
            {
                ...
                if ((!String.IsNullOrEmpty(InitialDate)) || (!String.IsNullOrEmpty(FinalDate)))
                {
                    ...
                    if (band)
                    {
                        ...
                        {
                            this.HttpContext.Session["Display"] = "The Final Date must be major than Initial Date, please set a correct date.";
                            band = false;
                        }
                ...
                if (((!String.IsNullOrEmpty(searchString)) || (!String.IsNullOrEmpty(searchUnit)) || (!String.IsNullOrEmpty(searchLogNo)) || 
                    (!String.IsNullOrEmpty(searchFee)) || (!String.IsNullOrEmpty(InitialDate)) || (!String.IsNullOrEmpty(FinalDate)) || 
                    (!String.IsNullOrEmpty(currentFilter)) || (!String.IsNullOrEmpty(currentUnit)) || (!String.IsNullOrEmpty(currentLlogNo)) || 
                    (!String.IsNullOrEmpty(currentFee)) || (!String.IsNullOrEmpty(InitialFilter)) || (!String.IsNullOrEmpty(FinalFilter))                  
                    ) && band)
                {
                    ...
                    if ((!String.IsNullOrEmpty(InitialDate)) && (!String.IsNullOrEmpty(FinalDate)))
                    {
                        ...
                        //Fecha final
                        trans2 = FinalDate.Replace("-", "");
                        final = Convert.ToInt32(trans2);
